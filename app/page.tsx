      ...
      <header className="bg-white/80 backdrop-blur-sm border-b border-stone-200 sticky top-0 z-50">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            ...
            <span className="text-3xl font-halimun text-stone-800">Nhân</span>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center text-white">
            ...
            <div className="space-y-8">
              <div className="space-y-4">
                <h1 className="text-4xl lg:text-6xl font-halimun leading-tight">Nhân</h1>
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          <div className="border-t border-stone-700 mt-12 pt-8 text-center">
            <p className="text-stone-400">
              © {new Date().getFullYear()} <span className="font-halimun">Nhân</span> Coaching. {t("allRightsReserved")}
            </p>
          </div>
        </div>
      </footer>
